...
>>> 
= RESTART: C:\Users\sunhy\Documents\UNIV\3-2\CA\python_programming\assignments\w2_tmp.py
Type any senetence in english : Been missed OC so so bad
Occurences of each word you typed:  {'Been': 1, 'missed': 1, 'OC': 1, 'so': 2, 'bad': 1}
Occurences of each letter you typed:  {'B': 1, 'e': 3, 'n': 1, 'm': 1, 'i': 1, 's': 4, 'd': 2, 'O': 1, 'C': 1, 'o': 2, 'b': 1, 'a': 1}
>>> 
```
